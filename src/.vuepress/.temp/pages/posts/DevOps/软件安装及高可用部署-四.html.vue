...
<a href="https://redis.io/download" target="_blank" rel="noopener noreferrer">https://redis.io/download<ExternalLinkIcon/></a>
...
<p>当redis-master服务器出现故障，虚拟IP自动漂移到redis-backup服务器上时，此时禅道相关的session
