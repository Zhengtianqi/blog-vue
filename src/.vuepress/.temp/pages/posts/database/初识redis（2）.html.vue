<template><div><h1 id="_1、排序" tabindex="-1"><a class="header-anchor" href="#_1、排序" aria-hidden="true">#</a> 1、排序</h1>
...
<span class="token number">127.0</span><span class="token number">.0</span><span class="token number">.1</span><span class="token operator">:</span><span class="token number">6379</span><span class="token operator">></span> sort myList asc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_2、事务" tabindex="-1"><a class="header-anchor" href="#_2、事务" aria-hidden="true">#</a> 2、事务</h1>
...
<h1 id="_3、键的过期时间" tabindex="-1"><a class="header-anchor" href="#_3、键的过期时间" aria-hidden="true">#</a> 3、键的过期时间</h1>
